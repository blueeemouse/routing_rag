# Feature-Fused Router Training Script
#
# Model: Feature-Fused Router (Semantic + Handcrafted Features)
#   - Semantic: BGE-base (768-dim)
#   - Handcrafted: 63-dim (based on RouteRAG paper)
#   - Total: 831-dim → Projection → 768-dim → Classifier
#
...
#   - Combines semantic embeddings with handcrafted features
#   - Direct classification (not similarity-based)
...
Write-Host "Feature-Fused Router Training" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
...
$OutputDir = "router_models/feature_fused_bge_$Timestamp"
...
Write-Host "  Use Projection: $UseProjection" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  3. Load model for inference: FeatureFusedRouter('$OutputDir\final')" -ForegroundColor Cyan
